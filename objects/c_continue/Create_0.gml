...
switch global.player_main 
{
    ...
    break;
	case PLAYER_SUKA:
        character_main = obj_continue_suka;
    break;
}

character_main = instance_create(half_width, half_height + 55, character_main);
...
{
    character_main.x -= 9;
    character_buddy = instance_create(half_width + 24, half_height + 58, character_buddy);
}
